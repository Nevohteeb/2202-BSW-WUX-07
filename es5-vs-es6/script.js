...
// Still have local and global scoping but also have "block" scoping:
...
let book = showBook("Harry Potter", "JK Rowling");
console.log(book);
...
const newuser = {
    ...
    sayName: function() {
        console.log(`My name is ${this.name}`);
        // arrow function is smart enough to know this is refering to the new user object
        const fullName = () => {
